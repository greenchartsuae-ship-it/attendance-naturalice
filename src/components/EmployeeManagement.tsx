...
const SECTIONS = [
  ...
  "SALESMAN", "PROD NIGHT SHIFT", "AL QUOZ TECHNICIAN", "UMQ PRODUCTION", "UMQ - TECHNICIAN",
  "UMQ PRODUCTION NIGHT SHIFT", "FUJAIRAH FACTORY", "PROD NIGHT - LUXURY ICE",
];
...
function sectionToGroup(section: string): string {
  ...
  if (["UMQ PRODUCTION NIGHT SHIFT", "FUJAIRAH FACTORY"].includes(section)) return "FACTORY/PRODUCTION";
